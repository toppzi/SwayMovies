...
/* GTK apps — ${name} (from foot.ini colors-${mode}) */
...
@define-color insensitive_fg_color mix(#${fg}, #${borders}, 0.45);
@define-color borders #${borders};
@define-color accent_bg_color #${accent};
@define-color accent_color #${accent};
@define-color accent_fg_color #${sel_fg};
@define-color warning_color #${accent};
@define-color menu_bg_color #${bg};
@define-color menu_fg_color #${fg};
@define-color popover_bg_color #${sel_bg};
@define-color popover_fg_color #${fg};
@define-color window_bg_color #${bg};
@define-color window_fg_color #${fg};
@define-color view_bg_color #${bg};
@define-color view_fg_color #${fg};
@define-color headerbar_bg_color #${sel_bg};
@define-color headerbar_fg_color #${fg};
@define-color headerbar_border_color #${borders};
@define-color sidebar_bg_color #${sel_bg};
@define-color sidebar_fg_color #${fg};
@define-color sidebar_backdrop_color shade(#${sel_bg}, 0.92);
@define-color sidebar_border_color #${borders};

/* Menus, popovers, tooltips (fixes white context menus) */
menu,
.menu,
.context-menu,
menubar,
...
/* Sidebars and list panes (Lutris, prefs dialogs, GNOME-style sidebars) */
.sidebar,
list,
list.lutris-sidebar,
.lutris-sidebar {
...
.lutris-sidebar row label,
list.lutris-sidebar row label,
.sidebar row label,
list row label {
  color: @sidebar_fg_color;
}

.lutris-sidebar row image,
list.lutris-sidebar row image {
  color: @sidebar_fg_color;
}

.lutris-sidebar row:hover,
list.lutris-sidebar row.activatable:hover,
...
list.lutris-sidebar row:selected,
...
.lutris-sidebar row:selected label,
list.lutris-sidebar row:selected label,
.sidebar row:selected label,
list row:selected label {
  color: @theme_selected_fg_color;
}

.lutris-sidebar separator,
list.lutris-sidebar separator {
...
.lutris-sidebar button,
list.lutris-sidebar button {
  background-color: transparent;
  color: @sidebar_fg_color;
  border: none;
}
